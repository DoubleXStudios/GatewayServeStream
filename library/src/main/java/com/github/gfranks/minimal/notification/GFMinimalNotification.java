...
public class GFMinimalNotification implements View.OnClickListener {
    ...
    protected void doShow() {
        ...
        if (mSlideDirection == SLIDE_TOP) {
            animation = AnimationUtils.loadAnimation(mNotificationView.getContext(), R.anim.slide_in_top);
        } else {
            animation = AnimationUtils.loadAnimation(mNotificationView.getContext(), R.anim.slide_in_bottom);
        }
        ...
        animation.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationStart(Animation animation) {
                if (mSlideDirection == SLIDE_TOP) {
                    mNotificationView.setY(0);
                } else {
                    mNotificationView.setY(((View) mNotificationView.getParent()).getHeight() - mNotificationViewHeight);
                }
    ...
    protected void doDismiss() {
        ...
        Animation animation;
        if (mSlideDirection == SLIDE_TOP) {
            animation = AnimationUtils.loadAnimation(mNotificationView.getContext(), R.anim.slide_out_top);
        } else {
            animation = AnimationUtils.loadAnimation(mNotificationView.getContext(), R.anim.slide_out_bottom);
        }
        animation.setDuration(mAnimationDuration);
        animation.setAnimationListener(new Animation.AnimationListener() {
            @Override
